...
public class LoginController extends BaseController {
    ...
    public String utoLogin(User u, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (byEntity == null) {
            ...
            request.getSession().setAttribute(Consts.STATUS, byEntity.getStatus());
