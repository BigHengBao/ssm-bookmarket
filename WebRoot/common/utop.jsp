...
<div class="width100" style="height: 25px;background: #f0f0f0;">
    <div class="width1200 center_yh font14 c_66" style="height: 25px;line-height: 25px;">
        <font class="left_yh">欢迎来到张恒的书店商城！</font>
        <div class="right_yh" id="fast_jump">

            <c:if test="${username!=null}">
                <c:if test="${status==null}">
                    <a href="${ctx}/user/view">欢迎您：${username}</a>
                    <b></b>
                ...
                <c:if test="${status==1}"> <a href="${ctx}/user/view">欢迎您：${username}</a>
                    <b></b>
                    <a href="${ctx}/login/uTui">退出</a>
                    <b></b>
                    <a href="${ctx}/car/findBySql">我的购物车</a>
            ...
            <c:if test="${username==null}">
                ...
                <b></b>
                <a href="${ctx}/login/login">管理员登陆</a>
                <b></b>
...
<div class="width100 hidden_yh">
    ...
    <div class="width1200 center_yh hidden_yh">
        <a href="#" class="block_yh left_yh">
            <img src="${ctx}/resource/images/微信截图_20210527132104.jpg" alt="" style="height: 70px ; width: 170px">
        </a>
        <div class="right_yh" style="height:28px;width:316px;border:2px solid #dd4545;margin-top:0px;">
